...
import com.sanleng.electricalfire.ui.adapter.AInspAdapter;
...
public class AlnsptaskFragment extends BaseFragment {

	private ListView inspetionpehinglslistview;
	private AInspAdapter lnspAdapter;
	private View view;
...
//						lnspAdapter.bindData(getActivity(), allList, null);
//						if (pageNo == 1) {
