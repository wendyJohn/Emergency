 ...
 *
 */
public class EmergencyUnlockingActivity extends BaseActivity implements OnClickListener ,NearbyStationModel {
	private String mac;
	...
	private void Unlock(final String position, final String mac) {
		UnlockRequest.getUnlock(EmergencyUnlockingActivity.this,getApplicationContext(),position,mac);
	}
	...
	@Override
	public void NearbyStationSuccess(List<NearbyStation.DataBean.ListBean> stationlist) {
