...
import com.sanleng.electricalfire.ui.fragment.AlnsptaskFragment;
import com.sanleng.electricalfire.ui.fragment.NlnsptaskFragment;
 ...
 * @author Qiaoshi
 */
public class InspectionMissionActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		this.setContentView(R.layout.inspetiontask_activity);
		initview();
	}
	...
	private void InitViewPager() {
		...
		fragments.add(new NlnsptaskFragment());
		fragments.add(new AlnsptaskFragment());
	...
	private void InitTextView() {
		...
		voiceAnswer.setText("未处理");
		healthPedia.setText("已处理");
