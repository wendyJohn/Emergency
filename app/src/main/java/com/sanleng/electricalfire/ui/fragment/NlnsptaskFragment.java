...
import com.sanleng.electricalfire.ui.adapter.NInspAdapter;
import com.sanleng.electricalfire.ui.bean.InSpTaskBean;
...
public class NlnsptaskFragment extends BaseFragment {

	private ListView inspetionpehinglslistview;
	private NInspAdapter lnspAdapter;
	private View view;
...
//						lnspAdapter.bindData(getActivity(), allList, mHandler);
//						if (pageNo == 1) {
//							inspetionpehinglslistview.setAdapter(lnspAdapter);
//						}
//						lnspAdapter.notifyDataSetChanged();
//						pageNo++;
//						finish = true;
//
