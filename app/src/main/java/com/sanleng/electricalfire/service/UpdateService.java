package com.sanleng.electricalfire.service;
...
import com.sanleng.electricalfire.ui.activity.MainActivity;
...
public class UpdateService extends Service {
    ...
    public void onCreate() {
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            apkPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Electricalupdate";
            apkName = "Electricalfire.apk";
            registerBroader();
            setUpNotifiction();
