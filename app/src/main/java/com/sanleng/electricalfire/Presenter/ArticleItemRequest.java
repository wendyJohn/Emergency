...
public class ArticleItemRequest {
    //文章详情
    public static void getArticleItem(final ArticleModel articleModel, final Context context, final String ids, final String name, final String category, final int frequency) {
        ...
        call.enqueue(new Callback<ArticleItem>() {
            ...
            public void onResponse(Call<ArticleItem> call, Response<ArticleItem> response) {
                ...
                articleModel.ArticleItemSuccess(content,name,category,frequency);
            }
