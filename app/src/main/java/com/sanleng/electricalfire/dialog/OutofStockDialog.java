...
import com.sanleng.electricalfire.Presenter.MaterialRequest;
 ...
 * @author qiaoshi
 */
public class OutofStockDialog extends Dialog implements View.OnClickListener, MaterialDetailModel {
    ...
    private void MaterialDetails() {
        MaterialRequest.GetMaterial(OutofStockDialog.this, context, ids);
    }

    @Override
    public void MaterialDetailSuccess(String myname, String mynumber, String myspecification, String mymodel) {
    ...
    @Override
    public void MaterialDetailFailed() {
