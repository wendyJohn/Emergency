 ...
 * @author qiaoshi
 */
public class ReportLossDialog extends Dialog implements View.OnClickListener ,MaterialDetailModel {
    ...
    private void MaterialDetails() {
        MaterialRequest.GetMaterial(ReportLossDialog.this,context,ids);
    }
