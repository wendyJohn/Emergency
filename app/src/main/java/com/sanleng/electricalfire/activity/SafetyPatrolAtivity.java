 ...
 * @author Qiaoshi
 */
public class SafetyPatrolAtivity extends AppCompatActivity implements OnItemClickListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle arg0) {
        ...
        StatusBarUtil.setColor(SafetyPatrolAtivity.this, R.color.translucency);
        initView();
    }
