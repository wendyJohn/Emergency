...
import com.sanleng.electricalfire.adapter.RealDataAdapter;
 ...
 * @author Qiaoshi
 */
public class RealDataActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle arg0) {
        ...
        StatusBarUtil.setColor(RealDataActivity.this, R.color.translucency);
        ...
        realtimedatalslistview.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (is_divPage && scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE && pageNo <= allpage
                        && finish) {
                    finish = false;
                    new RealTimeDataRequest(RealDataActivity.this).getRealTimeData(pageNo + "");
    ...
    public class Receivers extends BroadcastReceiver {
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BROADCAST_ACTION_DISC)) {
                //刷新数据
                new RealTimeDataRequest(RealDataActivity.this).getRealTimeData("1");
            }
