...
public class HomeData {
    ...
    public static String[] TITLE = {"电气安全", "消防安全", "安防监控", "危化品柜", "安全巡查", "地图监控", "更多", "预警事件"};

    public static int[] IMG = {R.drawable.se_a, R.drawable.se_b, R.drawable.se_c,
            R.drawable.se_d, R.drawable.se_e,
            R.drawable.se_g, R.drawable.whole, R.drawable.se_f};
    ...
    public static final List<Integer> POSITION(ACache aCache) {
        ...
        if (string == null)// 默认
        {
            ...
            list.add(6);
            UtilFileDB.ADDFile(aCache, "home", "0,1,2,3,4,5");
            return list;
        } else {
