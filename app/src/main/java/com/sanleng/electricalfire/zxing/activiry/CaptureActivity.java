package com.sanleng.electricalfire.zxing.activiry;
...
import com.sanleng.electricalfire.Presenter.MaterialStatusRequest;
import com.sanleng.electricalfire.R;
import com.sanleng.electricalfire.dialog.OutofStockDialog;
import com.sanleng.electricalfire.dialog.ReportLossDialog;
import com.sanleng.electricalfire.dialog.TipsDialog;
import com.sanleng.electricalfire.dialog.WarehousingDialog;
import com.sanleng.electricalfire.model.MaterialStatusModel;
import com.sanleng.electricalfire.zxing.bean.ZxingConfig;
import com.sanleng.electricalfire.zxing.camera.CameraManager;
import com.sanleng.electricalfire.zxing.common.Constant;
import com.sanleng.electricalfire.zxing.decode.DecodeImgCallback;
import com.sanleng.electricalfire.zxing.decode.DecodeImgThread;
import com.sanleng.electricalfire.zxing.decode.ImageUtil;
import com.sanleng.electricalfire.zxing.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener,MaterialStatusModel {
    ...
    private com.sanleng.electricalfire.zxing.activiry.BeepManager beepManager;
    ...
    private void Warehousing() {
        MaterialStatusRequest.GetMaterialStatus(CaptureActivity.this, getApplicationContext(), ids, stationName, stationId, storageLocation, "emergencystation_in","");
    }
    ...
    private void OutOfStock() {
        if (stationName == null || "".equals(stationName)) {
            ...
            MaterialStatusRequest.GetMaterialStatus(CaptureActivity.this, getApplicationContext(), ids, stationName, stationId, storageLocation, "emergencystation_out","");
        }
    }
    ...
    private void ReportLoss() {
        if(stationName==null||"".equals(stationName)){
            ...
            MaterialStatusRequest.GetMaterialStatus(CaptureActivity.this, getApplicationContext(), ids, stationName, stationId, storageLocation, "emergencystation_break",reason);
        }
    }
    ...
    @Override
    public void WarehousingSuccess(String msg) {
        try {
    ...
    @Override
    public void WarehousingFailed() {
        new SVProgressHUD(CaptureActivity.this).showErrorWithStatus("入库失败");
    }

    @Override
    public void OutOfStockSuccess(String msg) {
        try {
            JSONObject jSONObject = new JSONObject(msg);
    ...
    @Override
    public void OutOfStockFailed() {
        new SVProgressHUD(CaptureActivity.this).showErrorWithStatus("出库失败");
    }

    @Override
    public void ReportLossSuccess(String msg) {
        try {
            JSONObject jSONObject = new JSONObject(msg);
            String message = jSONObject.getString("msg");
            if (message.equals("修改成功")) {
