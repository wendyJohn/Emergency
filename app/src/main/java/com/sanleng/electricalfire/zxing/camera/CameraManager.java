 ...
 *
 * Licensed under the Apache License, Version_mag 2.0 (the "License");
...
package com.sanleng.electricalfire.zxing.camera;
...
import com.sanleng.electricalfire.zxing.activiry.CaptureActivityHandler;
...
public final class CameraManager {
    ...
    private final com.sanleng.electricalfire.zxing.camera.CameraConfigurationManager configManager;
    private ZxingConfig config;
    private Camera camera;
    private com.sanleng.electricalfire.zxing.camera.AutoFocusManager autoFocusManager;
    ...
    public CameraManager(Context context, ZxingConfig config) {
        ...
        this.configManager = new com.sanleng.electricalfire.zxing.camera.CameraConfigurationManager(context);
...
//    }
    ...
    public synchronized void startPreview() {
        ...
        if (theCamera != null && !previewing) {
            ...
            previewing = true;
            autoFocusManager = new com.sanleng.electricalfire.zxing.camera.AutoFocusManager(camera);
        }
    }
